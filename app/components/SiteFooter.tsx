...
export default function SiteFooter() {
  return <footer>
    <div className="footerMain">
      <div className="footerBrand"><Link href="/" aria-label="Vedmaan Group home"><Image src="/assets/footer-logo.png" alt="Vedmaan Group" width={150} height={100} /></Link><p>Creating thoughtful communities and lasting value in Haryana since 2015.</p><div><a href="tel:+918383953751" aria-label="Call Vedmaan Group"><Phone /></a><a href="https://wa.me/918383953751" target="_blank" rel="noreferrer" aria-label="Chat with Vedmaan Group on WhatsApp"><MessageCircle /></a></div></div>
