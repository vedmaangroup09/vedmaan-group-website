...
export default function SiteFooter() {
  return <footer>
    <div className="footerMain">
      ...
      <div className="footerVisit"><h4>Connect</h4><p>Experience the communities in person or grow with our channel network.</p><a href="mailto:info@vedmaangroup.com">info@vedmaangroup.com <Mail /></a><Link href="/contact#enquiry">Book a site visit <ChevronRight /></Link><Link href="/become-our-agent">Become our agent <ChevronRight /></Link></div>
    </div>
